...
# Set the working directory to '/Scans'
setwd(paste(scans_path,'Scans', sep = ""))
...
for (f in scan_file_names){
  ...
  plot(x = lod.rna.addcovariatesonly, map = map, main = paste(gene_file_name, "~Sex + Diet", "RNA"))
  abline(h = 4, col = "red", lwd = 2)
  
  plot(x = lod.rna.dietint, map = map, main = paste(gene_file_name, "Diet Int", "RNA"))
  abline(h = 4, col = "red", lwd = 2)
  abline(h = 7, col = "yellow", lwd = 2)
  
  plot(x = lod.rna.sexint, map = map, main = paste(gene_file_name, "Sex Int", "RNA"))
  abline(h = 4, col = "red", lwd = 2)
  abline(h = 7, col = "yellow", lwd = 2)
  ...
  # Create 3 plots with 3 threshold lines
  plot(x = lod.protein.addcovariatesonly, map = map, main = paste(gene_file_name, "~Sex + Diet + Tag", "Protein"))
  abline(h = 4, col = "red", lwd = 2)
  abline(h = 7, col = "yellow", lwd = 2)
  abline(h = 10, col = "black", lwd = 2)
  
  plot(x = lod.protein.dietint, map = map, main = paste(gene_file_name, "Diet Int", "Protein"))
  abline(h = 4, col = "red", lwd = 2)
  abline(h = 7, col = "yellow", lwd = 2)
  abline(h = 10, col = "black", lwd = 2)
  
  plot(x = lod.protein.sexint, map = map, main = paste(gene_file_name, "Sex Int", "Protein"))
  abline(h = 4, col = "red", lwd = 2)
  abline(h = 7, col = "yellow", lwd = 2)
  abline(h = 10, col = "black", lwd = 2)
