...
gene.names <- read.csv("/Users/c-allanb/Desktop/DO192Liver_aaRS/Data/Input/aa-tRNA_Sequence_Names.csv", header = FALSE)
...
scans_path <- '/Users/c-allanb/Desktop/DO192Liver_aaRS/Data/Input/'
...
```{r, eval = F}
# save the table 
write.table(peaks_diff_marker_df, file = "/Users/c-allanb/Desktop/DO192Liver_aaRS/Data/Output/peak_data/diff_data", row.names = FALSE, sep = "\t")
...
```{r}
file_path <- "/Users/c-allanb/Desktop/DO192Liver_aaRS/Data/Output/peak_data/diff_data"
...
distinct_peaks_data <-  distinct(peaks_diff_data, chr, Gene, Type, Covariates, .keep_all = TRUE)%>%
  filter(lod >= 7, Covariates == "Additive") # get the significant peaks
```

```{r}

# reestablish  paths 
scans_path <- '/Users/c-allanb/Desktop/DO192Liver_aaRS/Data/Input/Scans/'

path <-  "/Users/c-allanb/Desktop/DO192Liver_aaRS/"
```
...
coef_scan_plot.prot <-  function(chromosome, type, diff_diet, diff_sex, gene_name) {
  ...
  if (chromosome != "20" && diff.d <=4 && diff.s <=4 ) {
    ...
    save(coef_scan_add.prot, file = paste(path, "Data/Output/Scans/founder_effects/pQTL/", gene_name, "_chr", chromosome, "_Add_coef_scan.Rdata", sep = ""))
  ...
  if (chromosome != "20" && diff_diet >=4) {
    ...
    coef_scan_diet_int.prot <- scan1coef(genoprobs=probs[mice.with.data.p, chromosome],
                                    ...
                                    reml=TRUE)
    # Save
    save(coef_scan_diet_int.prot, file = paste(path, "Data/Output/Scans/founder_effects/pQTL/", gene_name, "_chr", chromosome, "_Diet_coef_scan.Rdata", sep = ""))
  ...
  if (chromosome != "20" && diff_sex >=4){
    ...
    save(coef_scan_sex_int.prot, file = paste(path, "Data/Output/Scans/founder_effects/pQTL/", gene_name, "_chr", chromosome, "_Sex_coef_scan.Rdata", sep = ""))
...
coef_scan_plot.rna <-  function(chromosome, type, diff_diet, diff_sex, gene_name) {
  ...
  if (chromosome != "20" && diff_diet <= 4 && diff_sex <=4) {
    ...
    save(coef_scan_add.rna, file = paste(path, "Data/Output/Scans/founder_effects/eQTL/", gene_name, "_chr", chromosome, "_Add_coef_scan.Rdata", sep = ""))
  ...
  if (chromosome != "20" && diff_diet >=4) {
    ...
    coef_scan_diet_int.rna <- scan1coef(genoprobs=probs[mice.with.data.r, chromosome],
                                    ...
                                    reml=TRUE)
    save(coef_scan_diet_int.rna, file = paste(path, "Data/Output/Scans/founder_effects/eQTL/", gene_name, "_chr", chromosome, "_Diet_coef_scan.Rdata", sep = ""))
  ...
  if (chromosome != "20" && diff_sex >= 4){
    ...
    coef_scan_sex_int.rna <- scan1coef(genoprobs=probs[mice.with.data.r, chromosome],
                            ...
                            reml=TRUE)
    save(coef_scan_sex_int.rna, file = paste(path, "Data/Output/Scans/founder_effects/eQTL/", gene_name, "_chr", chromosome, "_Sex_coef_scan.Rdata", sep = ""))
...
coef_scan_path <- "/Users/c-allanb/Desktop/DO192Liver_aaRS/Data/Output/Scans"
