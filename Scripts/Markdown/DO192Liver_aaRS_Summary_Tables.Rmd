...
```{r}
file_path <- "/Users/c-allanb/Desktop/DO192Liver/Data/Output/peak_data/"
...
# add back distant!!!!
summary_tbl.prot <- data_frame(Type ="pQTL", Total = sum(addt_count.prot, diet_int_count.prot, sex_int_count.prot), Additive = addt_count.prot, Diet_Int = diet_int_count.prot, Sex_Int = sex_int_count.prot)
```
#### RNA 
```{r}
...
summary_tbl.rna <- data_frame(Type = "eQTL", Total = sum(addt_count.rna, diet_int_count.rna, sex_int_count.rna), Additive = addt_count.rna, Diet_Int = diet_int_count.rna, Sex_Int = sex_int_count.rna)
```
...
path <- paste("/Users/", user, "/Desktop/DO192Liver/Data/Output/Summary_Tables", sep="")
